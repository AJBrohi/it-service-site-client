...
const AddOrder = () => {
  ...
  useEffect(() => {
    fetch('https://damp-shelf-97362.herokuapp.com/services')
      .then(res => res.json())
      .then(data => setServiceList(data))

    fetch('https://damp-shelf-97362.herokuapp.com/prices')
      .then(res => res.json())
  ...
  const handleSubmit = (event) => {
    ...
    fetch('https://damp-shelf-97362.herokuapp.com/addOrder', {
      method: "POST",
      headers: {
